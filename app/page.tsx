  ...
  const data = [
    {
      ...
      description: `A production mobile app, admin panel, Node.js API, and PostgreSQL database — built in ${OFFER.buildDays} days and carried through store release by day ${OFFER.days}, for a fixed quote of ${OFFER.priceINR}.`,
      offers: {
        "@type": "AggregateOffer",
        lowPrice: "50000",
        highPrice: "100000",
